...
type Props = {
    requestId: number;
    // We will add functions here later to close the popup
};


export default function RequestPopup({ requestId }: Props) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-8 w-full max-w-sm shadow-xl">
                ...
                <p className="text-zinc-400 text-sm mb-6">Request #{requestId}</p>
